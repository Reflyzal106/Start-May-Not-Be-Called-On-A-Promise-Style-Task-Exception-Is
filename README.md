# [SOLVED] Start-May-Not-Be-Called-On-A-Promise-Style-Task-Exception-Is
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/start-may-not-be-called-on-a-promise-style-task-exception-is)
>
...
Use Task.Run or Task.Factory.StartNew to execute the task.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/start-may-not-be-called-on-a-promise-style-task-exception-is)**
